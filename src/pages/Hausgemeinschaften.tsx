...
import { ArrowRight, Users, CheckCircle2, Shield, Handshake, Gift, Clock } from "lucide-react";
...
const HausgemeinschaftenPage = () => {
  ...
  const consultationPackage = {
    ...
    description: "In unserer kostenlosen Erstberatung analysieren wir Ihre Situation und zeigen Ihnen alle Möglichkeiten auf.",
